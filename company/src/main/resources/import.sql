...
insert into worker(name, password, email, phone, payment, role, site_id) values('Tóth János', 'asd123', 'tothjanos@example.com','+36405050505', 120000, 'EMPLOYEE', 1);
insert into worker(name, password, email, phone, payment, role, site_id) values('Rácz Mihály', 'password', 'misi@example.com','+36211234566', 300000, 'EMPLOYER', 2);
